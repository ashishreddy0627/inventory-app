...
public class InventoryController {
    ...
    public InventoryController(ItemRepository itemRepository, StoreRepository storeRepository, AppUserRepository appUserRepository) {
    ...
    public Store createStore(@RequestBody Store store) {
        ...
        AppUser owner = appUserRepository.findByEmail("owner@example.com").orElseThrow(() -> new IllegalStateException("default owner user not found"));
    ...
    public ResponseEntity<?> updateItem(@PathVariable Long id, @RequestBody Item updatedItem) {
        ...
        item.setCurrentStock(updatedItem.getCurrentStock());
        item.setReorderLevel(updatedItem.getReorderLevel());
        item.setTargetStock(updatedItem.getTargetStock());
    ...
    public ResponseEntity<?> deleteStore(@PathVariable Long id) {
        ...
        List<Item> items = itemRepository.findByStoreId(id);
        if (!items.isEmpty()) {
            return ResponseEntity.badRequest()
                .body("Cannot delete store with existing items. Delete items first.");
        }
